class Mock {
	...
	static products(filter) {
		var product1 = new Product(1, "Brinquedo Cachorro", 12.10, "O melhor brinquedo para o seu cachorro", 10);
	    var product2 = new Product(2, "Brinquedo Gato", 17.50, "O melhor brinquedo para o seu gato", 10);

	    product1.category = "Brinquedo";
	    product2.category = "Brinquedo";

	    var product3 = new Product(3, "Coleira Cachorro", 32.99, "A melhor coleira para o seu cachorro", 10);
	    var product4 = new Product(4, "Coleira Gato", 23.79, "A melhor coleira para o seu gato", 10);

	    product3.category = "Coleira";
	    product4.category = "Coleira";

	    var product5 = new Product(5, "Ração Cachorro", 68.59, "A melhor ração para o seu cachorro", 10);
	    var product6 = new Product(6, "Ração Gato", 36.69, "A melhor ração para o seu gato", 10); 
