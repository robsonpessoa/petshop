$(document).ready(function(){
	...
	$('#prod_items').on('click','#edit_button_catalogue', function(){
		...
		if($('.edit_button_catalogue_items').length < 1){
		// Button does not exist
			var $input = $('<input class="edit_button_catalogue_items_remove min_button small_button alert" type="button" value="-" />');
			$input.appendTo($("#prod_items ul li"));
			
		}
		
		var $input2 = $('<input class="edit_button_catalogue_items_modify min_button" type="button" value="modify" />');
			$input2.appendTo($("#prod_items ul li"));
		
		var $input = $('<input class="edit_button_prod_items_add small_button min_button" type="button" value="+" />');
   ...
   $("menu").mouseenter(function(){
	...
	$('#prod_items').on('click','.edit_button_catalogue_items_modify', function(e) {
		...
		$(div).load("html/admin_modify_product_popup.html");
	...
	$("menu").on('click','.edit_button_menu_items_modify', function(e) {
		...
		$('#pageloader').append(div);
		$(div).load("html/admin_modify_menu_popup.html");
